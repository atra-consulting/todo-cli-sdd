...
- **Global scope**: `/Users/daniel.schock/Development.localized/repository/atra/todo-cli-sdd/todo-cli-gsd/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/daniel.schock/Development.localized/repository/atra/todo-cli-sdd/todo-cli-gsd/.claude/notes/`)
...
2. Glob `/Users/daniel.schock/Development.localized/repository/atra/todo-cli-sdd/todo-cli-gsd/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/daniel.schock/Development.localized/repository/atra/todo-cli-sdd/todo-cli-gsd/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/daniel.schock/Development.localized/repository/atra/todo-cli-sdd/todo-cli-gsd/.claude/notes/` — works in any directory
